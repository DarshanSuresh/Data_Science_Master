...
- âœ… Default view with raw data and its statistics info
- âœ… Drag on the header to re-arrange columns
- âœ… Left click on the right panel to show/hide columns
- âœ… Plots: histogram, heatmap, correlation, scatter, box, violin, pair 
- âœ… Bottom right buttons to hide panels and focus on data set
- âœ… Easy to see memory usage and logs in bottom status bar
- âœ… Easy to use in command line, jupyter notebook and docker
